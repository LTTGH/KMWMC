...
setting3= function(seed,nlist = c(100,200)){
  library(DMwR)
  library(e1071)
  ## Linear
  ...
  for(ns in nlist){
    ...
    discrete_psDR_CMCIMP=tuningParamSet1(px,"DR","RBF",psPath1,impPath1,1) # PSmodel=1, Regmodel=1
    ...
    discrete_psDR_CMMIMP=tuningParamSet1(px,"DR","RBF",psPath1,impPath0,1) # PSmodel=1, Regmodel=0
    ...
    discrete_psDR_MMCIMP=tuningParamSet1(px,"DR","RBF",psPath0,impPath1,1)
    ...
    # ## both misspecified
    discrete_psDR_MMMIMP=tuningParamSet1(px,"DR","RBF",psPath0,impPath0,1)
